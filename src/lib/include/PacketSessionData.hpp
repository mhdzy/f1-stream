...
extern std::vector<std::pair<int, std::string>> MarshalZonePairs;
...
extern std::vector<std::pair<int, std::string>> WeatherForecastSamplePairs;

extern std::string PacketSessionDataCSVHeader();
...
extern std::vector<std::pair<int, std::string>> PacketSessionDataPairs;
